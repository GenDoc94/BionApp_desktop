...
import { chipTieneHuecoDisponible, collectChipAsignacionesFromMuestras, fcLibresParaChip, fcYaOcupado, } from "./chipDisponibilidad";
var muestrasFixture = [
    {
        lecturas: [
            {
...
describe("chipDisponibilidad", function () {
    it("detecta FC libres en un chip", function () {
        var asig = collectChipAsignacionesFromMuestras(muestrasFixture);
    ...
    it("excluye la fila actual al editar FC", function () {
        var asig = collectChipAsignacionesFromMuestras(muestrasFixture);
        var actual = asig[0];
